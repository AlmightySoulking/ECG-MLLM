...
#     import pudb; pudb.set_trace()
    ...
    if 'vis_processor' in cfg.datasets_cfg.get(key):
        vis_processor_cfg = cfg.datasets_cfg.get(key).vis_processor.train
    elif 'ecg_processor' in cfg.datasets_cfg.get(key):
        vis_processor_cfg = cfg.datasets_cfg.get(key).ecg_processor.train
    else:
        raise ValueError("No vis_processor or ecg_processor found in dataset config.")
